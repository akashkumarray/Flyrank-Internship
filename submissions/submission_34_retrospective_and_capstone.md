...
> 🌐 Live Research Paper: https://akashkumarray.github.io/Flyrank-Internship/  
> 🎓 Verified Credential: https://internship.flyrank.ai/verify?id=FR-D1-FEA2F-84A32&first_name=Akash  
> 💻 GitHub Repository: https://github.com/akashkumarray/Flyrank-Internship
...
* **0:00 - 1:00 (Live Site Walkthrough & The One Claim):**  
  Walk the live website at `https://akashkumarray.github.io/Flyrank-Internship/`. State the one claim: *"Predicting organic search traffic decay with 84.00% Precision@50 on 79M anonymized search queries."*
...
|---|---|---|
| **Live Custom Domain URL** | PASSED | Deployed over HTTPS at [https://akashkumarray.github.io/Flyrank-Internship/](https://akashkumarray.github.io/Flyrank-Internship/). |
