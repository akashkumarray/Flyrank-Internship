...
**Mandatory URL Pointer File:** [`submission/paper_url.txt`](../submission/paper_url.txt) (`https://akashkumarray.github.io/Flyrank-Internship/`)  
**Live Deployed Research Paper URL:** [`https://akashkumarray.github.io/Flyrank-Internship/`](https://akashkumarray.github.io/Flyrank-Internship/)  
...
3. **Single-Line URL Pointer:** [`submission/paper_url.txt`](../submission/paper_url.txt) contains exactly one line:
   `https://akashkumarray.github.io/Flyrank-Internship/`
...
|---|---|---|
| **Deployed Paper URL** | PASSED | Live over HTTPS at [https://akashkumarray.github.io/Flyrank-Internship/](https://akashkumarray.github.io/Flyrank-Internship/). |
